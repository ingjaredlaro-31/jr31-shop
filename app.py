...
st.markdown("""
    ...
    div[role="radiogroup"] label { font-size: 1.7rem !important; font-weight: 700; color: #FFFFFF !important; margin-bottom: 20px !important; }
...
# --- 3. INICIALIZACIÓN DE DATOS (MANTENIMIENTO) ---
def init_db():
...
# --- 4. MOTOR PDF ---
def create_pdf(client, items, total):
...
if not st.session_state.auth:
    ...
    # --- STOCK (CORREGIDO: EDITAR Y ELIMINAR) ---
    ...
    # --- REPORTES ---
        ...
        st.download_button("📥 EXCEL", buf.getvalue(), "JR31_MASTER.xlsx")
